...
document.getElementById('superAdminOpenLink').addEventListener('click', async (e) => {
  e.preventDefault();
  const pw = prompt('총괄관리자 비밀번호를 입력하세요.');
  if (pw === null) return;
...
document.getElementById('superAdminBackBtn').addEventListener('click', () => {
  showScreen('screen-login');
});
